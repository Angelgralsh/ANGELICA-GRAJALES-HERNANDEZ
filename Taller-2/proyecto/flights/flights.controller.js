...
let FlightsController = class FlightsController {
    list(origin, date, nonstop, limit = 20) {
...
__decorate([
    ...
    __param(2, (0, common_1.Query)('nonstop', common_1.ParseBoolPipe)),
...
__decorate([
    ...
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
    __param(1, (0, common_1.Body)('passengerId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, Number]),
    __metadata("design:returntype", void 0)
], FlightsController.prototype, "addPassenger", null);
__decorate([
    (0, common_1.Patch)(':id'),
    __param(0, (0, common_1.Param)('id', common_1.ParseIntPipe)),
